...
> Відкрити цю сторінку в [https://ruslanus00.github.io/z/](https://ruslanus00.github.io/z/)
...
* шукайте **https://github.com/ruslanus00/z** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/ruslanus00/z/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/ruslanus00/z** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/ruslanus00/z/raw/master/.github/makecode/blocks.png)
